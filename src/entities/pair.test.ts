import { Token, WETH9, Price, CurrencyAmount } from '@marx-dex/marx-dex-sdk-core'
...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    ...
    expect(result).toEqual('0x9b491af38EeB5D15B21165a7Dc4578ADCd30CBE9')
  })
...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x951464ff2ea5038B0D35695f01329D1389A680a6')
    })
  })
